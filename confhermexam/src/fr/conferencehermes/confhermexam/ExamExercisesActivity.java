...
public class ExamExercisesActivity extends FragmentActivity implements OnClickListener {
        ...
        if (!Utilities.readBoolean(ExamExercisesActivity.this, key, false)) {
          ...
          if (getIntent().getBooleanExtra("examIsConference", false)) {
            ...
            Utilities.showAlertDialog(ExamExercisesActivity.this, "Attention", getResources()
                .getString(R.string.exam_already_passed_alert));
        }
      }
    });
  ...
  private void openExercise(int id, boolean isActive) {
    Intent intent = new Intent(ExamExercisesActivity.this, ExaminationActivity.class);
  ...
  protected void onDestroy() {
    Utilities.writeBoolean(ExamExercisesActivity.this, String.valueOf("exam" + examId), false);
    super.onDestroy();
  }

  @Override
  public void onBackPressed() {
    showAlertDialog("Attention", getResources().getString(R.string.exercise_finish_text));
  }

  public void showAlertDialog(String title, String message) {
    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ExamExercisesActivity.this);

    alertDialogBuilder.setTitle(title);
    alertDialogBuilder.setMessage(message).setCancelable(false)
        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int id) {
            DatabaseHelper dbHelper = new DatabaseHelper(ExamExercisesActivity.this);
            ArrayList<Exercise> dbExercises = dbHelper.getAllExercisesByExamId(examId);
  ...
  public void sendEmptyAnswers(Exercise exercise) throws JSONException {
    ...
    object.put("auth_key", Utilities.readString(ExamExercisesActivity.this, "auth_key", ""));
    object.put("device_id", Utilities.getDeviceId(ExamExercisesActivity.this));
    object.put("device_time", System.currentTimeMillis() / 1000);
    object.put("data", data);

    if (Utilities.isNetworkAvailable(ExamExercisesActivity.this)) {
      ExamJsonTransmitter transmitter = new ExamJsonTransmitter(ExamExercisesActivity.this);
