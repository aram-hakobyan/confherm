...
public class LoginActivity extends Activity implements ActionDelegate {
	...
	public void loginAction() {
		...
		final String uname = "Test";// username.getText().toString().trim();
		final String pass = "Test";// password.getText().toString().trim();
		...
		if (!uname.isEmpty() && !pass.isEmpty()) {
			...
			Constants.AUTH_TOKEN, authToken, "armen_mkrtchyan",
					"armen_mkrtchyan", "Student1!", "Student1!", "commit",
					"Log In");
