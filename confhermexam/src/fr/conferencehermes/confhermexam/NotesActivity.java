...
public class NotesActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    vto.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
      ...
      public void onGlobalLayout() {
        ...
        listviewEx.getViewTreeObserver().removeGlobalOnLayoutListener(this);
      }
    });
    ...
    listviewEx.setOnItemClickListener(new OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        globalTest.setBackgroundColor(getResources().getColor(R.color.global_normal_color));
    ...
    globalTest.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        globalTest.setBackgroundColor(getResources().getColor(R.color.app_main_color_dark));
        ...
        if (listviewNt != null) {
          ...
          listviewNt.postDelayed(new Runnable() {
            ...
            public void run() {
              ...
              int firstPosition =
                  listviewNt.getFirstVisiblePosition() - listviewNt.getHeaderViewsCount();
              wantedChild = wantedPosition - firstPosition;
              View wantedView = listviewNt.getChildAt(wantedChild);
              if (wantedView != null) {
                wantedView.requestFocus();

                wantedView.setBackgroundColor(getResources().getColor(R.color.app_main_color));
              }
    ...
    if (NetworkReachability.isReachable()) {
      ...
      aqExersice.ajax(Constants.CURRENT_EXAM_URL, paramsExersice, JSONObject.class,
  ...
  private void selectExersiceBackground(ExamExercise r, int position, boolean glabalButton) {

    if (glabalButton) {
      int wantedPosition = position;
      int firstPosition = listviewEx.getFirstVisiblePosition() - listviewEx.getHeaderViewsCount();
      int wantedChild = wantedPosition - firstPosition;
      if (wantedChild >= 0 && wantedChild < listviewEx.getChildCount()) {
        for (int i = 0; i < listviewEx.getChildCount(); i++) {
          if (i == wantedChild)
            listviewEx.getChildAt(i).setBackgroundColor(
                getResources().getColor(R.color.excercise_selected_color));
          else
            listviewEx.getChildAt(i).setBackgroundColor(
                getResources().getColor(R.color.excercise_normal_color));
        }
