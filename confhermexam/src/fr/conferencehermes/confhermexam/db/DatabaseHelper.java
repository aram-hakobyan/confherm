...
public class DatabaseHelper extends SQLiteOpenHelper {
  ...
  private static final String KEY_EXERCISE_IS_ALREADY_PASSED = "exerciseIsAlreadyPassed";
  ...
  private static final String CREATE_TABLE_EVENT = "CREATE TABLE " + TABLE_EVENTS + "("
      + KEY_EVENT_ID + " INTEGER PRIMARY KEY," + KEY_EVENT_NAME + " TEXT," + KEY_EVENT_VALIDATION
      + " INTEGER," + KEY_EVENT_TEST_ID + " INTEGER," + KEY_EVENT_AUTHOR + " INTEGER,"
      + KEY_EVENT_CREATION_DATE + " INTEGER," + KEY_EVENT_LAST_EDIT_TIME + " INTEGER" + ")";

  // Exam table create statement
  private static final String CREATE_TABLE_EXAM = "CREATE TABLE " + TABLE_EXAMS + "(" + KEY_EXAM_ID
      + " INTEGER PRIMARY KEY," + KEY_EXAM_EVENT_ID + " INTEGER," + KEY_EXAM_START_DATE
      + " INTEGER," + KEY_EXAM_END_DATE + " INTEGER," + KEY_EXAM_PASSWORD + " TEXT,"
      + KEY_EXAM_NAME + " TEXT," + KEY_EXAM_TYPE + " TEXT," + KEY_EXAM_LAST_EDIT_TIME + " INTEGER,"
      + KEY_EXAM_STATUS + " INTEGER," + KEY_EXAM_IS_ALREADY_PASSED + " INTEGER,"
      + KEY_EXAM_EVENT_NAME + " TEXT" + ")";

  // ExerciseFiles table create statement
  private static final String CREATE_TABLE_EXERCISE_FILES = "CREATE TABLE " + TABLE_EXERCISE_FILES
      + "(" + KEY_EXERCISE_FILES_ID + " INTEGER PRIMARY KEY," + KEY_EXERCISE_FILES_IMAGE + " TEXT,"
      + KEY_EXERCISE_FILES_AUDIO + " TEXT," + KEY_EXERCISE_FILES_VIDEO + " TEXT" + ")";

  // Exercises table create statement
  private static final String CREATE_TABLE_EXERCISE = "CREATE TABLE " + TABLE_EXERCISES + "("
      + KEY_EXERCISE_ID + " INTEGER PRIMARY KEY," + KEY_EXERCISE_NAME + " TEXT,"
      + KEY_EXERCISE_TYPE + " TEXT," + KEY_EXERCISE_IS_ALREADY_PASSED + " INTEGER,"
      + KEY_EXERCISE_CREATED_BY + " TEXT," + KEY_EXERCISE_TEXT + " TEXT," + KEY_EXERCISE_EXAM_ID
      + " INTEGER" + ")";

  // QuestionFiles table create statement
  private static final String CREATE_TABLE_QUESTION_FILES = "CREATE TABLE " + TABLE_QUESTION_FILES
      + "(" + KEY_QUESTION_FILES_ID + " INTEGER PRIMARY KEY," + KEY_QUESTION_FILES_IMAGE + " TEXT,"
      + KEY_QUESTION_FILES_AUDIO + " TEXT," + KEY_QUESTION_FILES_VIDEO + " TEXT" + ")";

  // CorrectionFiles table create statement
  private static final String CREATE_TABLE_CORRECTION_FILES = "CREATE TABLE "
      + TABLE_CORRECTION_FILES + "(" + KEY_CORRECTION_FILES_ID + " INTEGER PRIMARY KEY,"
      + KEY_CORRECTION_FILES_IMAGE + " TEXT," + KEY_CORRECTION_FILES_AUDIO + " TEXT,"
  ...
  private static final String CREATE_TABLE_QUESTION = "CREATE TABLE " + TABLE_QUESTIONS + "("
      + KEY_QUESTION_ID + " INTEGER PRIMARY KEY," + KEY_QUESTION_TEXT + " TEXT,"
      + KEY_QUESTION_TYPE + " TEXT," + KEY_QUESTION_INPUT_COUNT + " INTEGER,"
      + KEY_QUESTION_EXERCISE_ID + " INTEGER" + ")";

  // User table create statement
  private static final String CREATE_TABLE_USER = "CREATE TABLE " + TABLE_USERS + "(" + KEY_USER_ID
      + " INTEGER PRIMARY KEY," + KEY_USERNAME + " TEXT," + KEY_USER_EMAIL + " TEXT,"
      + KEY_USER_FIRSTNAME + " TEXT," + KEY_USER_LASTNAME + " TEXT," + KEY_USER_GROUPS + " BLOB"
      + ")";
  ...
  private static final String CREATE_TABLE_ANSWERS = "CREATE TABLE " + TABLE_ANSWERS + "("
      ...
      + KEY_ANSWER_QUESTION_ID + " INTEGER" + ")";

  // Exercise Answers table create statement
  private static final String CREATE_TABLE_EXERCISE_ANSWERS = "CREATE TABLE "
      + TABLE_EXERCISE_ANSWERS + "(" + KEY_EXERCISE_ANSWER_EXERCISE_ID + " INTEGER PRIMARY KEY,"
      + KEY_EXERCISE_ANSWER_EXAM_ID + " INTEGER," + KEY_EXERCISE_ANSWER_EVENT_ID + " INTEGER,"
      + KEY_EXERCISE_ANSWER_JSONSTRING + " TEXT," + KEY_EXERCISE_ANSWER_IS_SENT + " INTEGER" + ")";
  ...
  public Event getEvent(long event_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EVENTS + " WHERE " + KEY_EVENT_ID + " = " + event_id;
    ...
    if (c != null && c.moveToFirst()) {
      ...
      event.setCreationDate(c.getLong(c.getColumnIndex(KEY_EVENT_CREATION_DATE)));
      ...
      event.setLastEditTime(c.getLong(c.getColumnIndex(KEY_EVENT_LAST_EDIT_TIME)));
      c.close();
    }
  ...
  public ArrayList<Event> getAllEvents() {
    ...
    if (c != null && c.moveToFirst()) {
      do {
        ...
        event.setId(c.getInt(c.getColumnIndex(KEY_EVENT_ID)));
        event.setAuthor((c.getString(c.getColumnIndex(KEY_EVENT_AUTHOR))));
        event.setCreationDate(c.getInt(c.getColumnIndex(KEY_EVENT_CREATION_DATE)));
        event.setName(c.getString(c.getColumnIndex(KEY_EVENT_NAME)));
        event.setTestId(c.getInt(c.getColumnIndex(KEY_EVENT_TEST_ID)));
        event.setValidation(c.getInt(c.getColumnIndex(KEY_EVENT_VALIDATION)));
        event.setLastEditTime(c.getLong(c.getColumnIndex(KEY_EVENT_LAST_EDIT_TIME)));
  ...
  public void deleteEvent(long event_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_EVENTS, KEY_EVENT_ID + " = ?", new String[] {String.valueOf(event_id)});
  }
  ...
  public long createExam(Exam exam) {
    ...
    long exam_id = -1;
    try {
      exam_id = db.insertWithOnConflict(TABLE_EXAMS, null, values, SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } finally {
      db.endTransaction();
    }
  ...
  public Exam getExam(long exam_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXAMS + " WHERE " + KEY_EXAM_ID + " = " + exam_id;
    ...
    if (c != null && c.moveToFirst()) {
      ...
      exam.setLastEditTime(c.getLong(c.getColumnIndex(KEY_EXAM_LAST_EDIT_TIME)));
      exam.setIsAlreadyPassed(c.getInt(c.getColumnIndex(KEY_EXAM_IS_ALREADY_PASSED)));
  ...
  public void deleteExam(long exam_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_EXAMS, KEY_EXAM_ID + " = ?", new String[] {String.valueOf(exam_id)});
  }
  ...
  public ArrayList<Exam> getAllExamsByEventId(int eventId) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXAMS + " WHERE " + KEY_EXAM_EVENT_ID + " = " + eventId;
  ...
  public long createQuestion(Question q) {
    ...
    long id = -1;
    try {
      id = db.insertWithOnConflict(TABLE_QUESTIONS, null, values, SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } catch (Exception e1) {
      e1.printStackTrace();
    } finally {
  ...
  public Question getQuestion(long question_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_QUESTIONS + " WHERE " + KEY_QUESTION_ID + " = " + question_id;
    ...
    if (c != null && c.moveToFirst()) {
      ...
      q.setExerciseId((c.getInt(c.getColumnIndex(KEY_QUESTION_EXERCISE_ID))));
  ...
  public void deleteQuestion(long question_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_QUESTIONS, KEY_QUESTION_ID + " = ?", new String[] {String.valueOf(question_id)});
  }
  ...
  public ArrayList<Question> getAllQuestionsByExerciseId(int exerciseId) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_QUESTIONS + " WHERE " + KEY_QUESTION_EXERCISE_ID + " = "
            + exerciseId;
  ...
  public long createQuestionFile(Question q) {
    ...
    try {
      id =
          db.insertWithOnConflict(TABLE_QUESTION_FILES, null, values,
  ...
  public HashMap<String, String> getQuestionFile(long question_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_QUESTION_FILES + " WHERE " + KEY_QUESTION_FILES_ID + " = "
            + question_id;
    HashMap<String, String> qFiles = new HashMap<String, String>();

    Cursor c = db.rawQuery(selectQuery, null);
    if (c != null && c.moveToFirst()) {
      qFiles.put("image", c.getString(c.getColumnIndex(KEY_QUESTION_FILES_IMAGE)));
      qFiles.put("sound", c.getString(c.getColumnIndex(KEY_QUESTION_FILES_AUDIO)));
      qFiles.put("video", c.getString(c.getColumnIndex(KEY_QUESTION_FILES_VIDEO)));
    }
  ...
  public long createCorrectionFile(Question q) {
    ...
    try {
      id =
          db.insertWithOnConflict(TABLE_CORRECTION_FILES, null, values,
              SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } catch (Exception e1) {
      e1.printStackTrace();
  ...
  public HashMap<String, String> getCorrectionFile(long question_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_CORRECTION_FILES + " WHERE " + KEY_CORRECTION_FILES_ID + " = "
            + question_id;
    HashMap<String, String> qFiles = new HashMap<String, String>();

    Cursor c = db.rawQuery(selectQuery, null);
    if (c != null && c.moveToFirst()) {
      qFiles.put("image", c.getString(c.getColumnIndex(KEY_CORRECTION_FILES_IMAGE)));
      qFiles.put("sound", c.getString(c.getColumnIndex(KEY_CORRECTION_FILES_AUDIO)));
      qFiles.put("video", c.getString(c.getColumnIndex(KEY_CORRECTION_FILES_VIDEO)));
    }
  ...
  public long createExercise(Exercise exercise) {
    ...
    long id = -1;
    try {
      id = db.insertWithOnConflict(TABLE_EXERCISES, null, values, SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } finally {
      db.endTransaction();
    }
  ...
  public Exercise getExercise(long exercise_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXERCISES + " WHERE " + KEY_EXERCISE_ID + " = " + exercise_id;
    ...
    if (c != null && c.moveToFirst()) {
      ...
      exercise.setTeacher(c.getString(c.getColumnIndex(KEY_EXERCISE_CREATED_BY)));
      exercise
          .setExerciseIsAlreadyPassed(c.getInt(c.getColumnIndex(KEY_EXERCISE_IS_ALREADY_PASSED)));
  ...
  public void deleteExercise(long exercise_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_EXERCISES, KEY_EXERCISE_ID + " = ?", new String[] {String.valueOf(exercise_id)});
  }
  ...
  public ArrayList<Exercise> getAllExercisesByExamId(int examId) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXERCISES + " WHERE " + KEY_EXERCISE_EXAM_ID + " = " + examId;
  ...
  public long createExerciseFile(Exercise e) {
    ...
    try {
      id =
          db.insertWithOnConflict(TABLE_EXERCISE_FILES, null, values,
              SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } catch (Exception e1) {
      e1.printStackTrace();
  ...
  public HashMap<String, String> getExerciseFile(long exercise_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXERCISE_FILES + " WHERE " + KEY_EXERCISE_FILES_ID + " = "
            + exercise_id;
    ...
    if (c != null && c.moveToFirst()) {
      eFiles.put("image", c.getString(c.getColumnIndex(KEY_EXERCISE_FILES_IMAGE)));
      eFiles.put("sound", c.getString(c.getColumnIndex(KEY_EXERCISE_FILES_AUDIO)));
      eFiles.put("video", c.getString(c.getColumnIndex(KEY_EXERCISE_FILES_VIDEO)));
      c.close();
    }
  ...
  public long createUser(Profile p) {
    ...
    long id = -1;
    try {
      id = db.insertWithOnConflict(TABLE_USERS, null, values, SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } finally {
      db.endTransaction();
    }
  ...
  public Profile getUser(long user_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_USERS + " WHERE " + KEY_USER_ID + " = " + user_id;
  ...
  public void deleteUser(long user_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_USERS, KEY_USER_ID + " = ?", new String[] {String.valueOf(user_id)});
  }
  ...
  public long createAnswer(Answer a) {
    ...
    long id = -1;
    try {
      id = db.insertWithOnConflict(TABLE_ANSWERS, null, values, SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } catch (Exception e1) {
      e1.printStackTrace();
    } finally {
  ...
  public Answer getAnswer(long answer_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_ANSWERS + " WHERE " + KEY_ANSWER_ID + " = " + answer_id;
  ...
  public void deleteAnswer(long answer_id) {
    SQLiteDatabase db = this.getWritableDatabase();
    db.delete(TABLE_ANSWERS, KEY_ANSWER_ID + " = ?", new String[] {String.valueOf(answer_id)});
  }
  ...
  public ArrayList<Answer> getAllAnswersByQuestionId(int questionId) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_ANSWERS + " WHERE " + KEY_ANSWER_QUESTION_ID + " = " + questionId
            + " ORDER BY " + KEY_ANSWER_NAME + " ASC";
  ...
  public long createExerciseAnswer(ExerciseAnswer a) {
    ...
    values.put(KEY_EXERCISE_ANSWER_IS_SENT, a.getIsSent());
    ...
    try {
      id =
          db.insertWithOnConflict(TABLE_EXERCISE_ANSWERS, null, values,
              SQLiteDatabase.CONFLICT_REPLACE);
      db.setTransactionSuccessful();
    } catch (Exception e1) {
      e1.printStackTrace();
  ...
  public ExerciseAnswer getExerciseAnswer(long answer_id) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXERCISE_ANSWERS + " WHERE " + KEY_EXERCISE_ANSWER_EXERCISE_ID
            + " = " + answer_id;
    ...
    if (c != null && c.moveToFirst()) {
      a.setExerciseId((c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EXERCISE_ID))));
      a.setExamId(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EXAM_ID)));
      a.setEventId(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EVENT_ID)));
      a.setJsonString(c.getString(c.getColumnIndex(KEY_EXERCISE_ANSWER_JSONSTRING)));
      a.setIsSent(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_IS_SENT)));
      c.close();
    }
  ...
  public int updateExerciseAnswer(ExerciseAnswer a) {
    ...
    // updating row
    return db.update(TABLE_EXERCISE_ANSWERS, values, KEY_EXERCISE_ANSWER_EXERCISE_ID + " = ?",
  ...
  public ArrayList<ExerciseAnswer> getAllExerciseAnswersByExamId(int examId) {
    ...
    SQLiteDatabase db = this.getReadableDatabase();
    String selectQuery =
        "SELECT  * FROM " + TABLE_EXERCISE_ANSWERS + " WHERE " + KEY_EXERCISE_ANSWER_EXAM_ID
            + " = " + examId;
    ...
    if (c != null && c.moveToFirst()) {
      do {
        ...
        a.setExerciseId((c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EXERCISE_ID))));
        a.setExamId(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EXAM_ID)));
        a.setExamId(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_EVENT_ID)));
        a.setJsonString(c.getString(c.getColumnIndex(KEY_EXERCISE_ANSWER_JSONSTRING)));
        a.setIsSent(c.getInt(c.getColumnIndex(KEY_EXERCISE_ANSWER_IS_SENT)));
        answers.add(a);
