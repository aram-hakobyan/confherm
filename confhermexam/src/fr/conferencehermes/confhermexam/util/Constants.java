...
public class Constants {
	...
	public static String SERVER_URL = "http://moodle.outsourcearmenia.com/api/login.php";
	public static String AUTH_TOKEN = "tk=a1fdec44bbb50b3b7e524b4aceb96ea359124749";
