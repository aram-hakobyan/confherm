...
public class ExaminationActivity extends Activity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    timer.start();
    exerciseTimer = new CounterClassForExercise(exercise.getDuration() * 60 * 1000, 1000);
    exerciseTimer.start();
  ...
  public class CounterClassForExercise extends CountDownTimer {
    ...
    public void onFinish() {
      ...
      if (!getIntent().getBooleanExtra("conference", false)) {
        showAlertDialogWhenExerciseTimeIsOver(ExaminationActivity.this, "Attention", getResources()
            .getString(R.string.exercise_finished_alert));
      }
    }
