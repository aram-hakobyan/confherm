...
public class DownloadsFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    View fragment = inflater.inflate(R.layout.activity_telechargement, container, false);
    ...
    progressBarTelecharge = (ProgressBar) fragment.findViewById(R.id.progressBarTelecharge);
  ...
  private void selectCurrentEventDownload(final int eventId) {
    ...
    if (listview != null) {
      ArrayList<DownloadInstance> downloads = DataHolder.getInstance().getDownloads();
      for (int i = 0; i < downloads.size(); i++) {
